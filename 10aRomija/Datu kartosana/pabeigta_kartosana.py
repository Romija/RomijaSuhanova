...
vardnica_dilstosi = sorted(vardnica, key=vardnica.get, reverse=True)
vardnica_kartots = {}

for key in vardnica_dilstosi:
    vardnica_kartots[key] = vardnica[key]

# Izdrukā stabiņā uz leju
for key, value in vardnica_kartots.items():
    print(f'{key}: {value}')
